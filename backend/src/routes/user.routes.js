...
userRouter.put('/:userName', validateToken, validateRolToken(['Administrador']), userController.update)
userRouter.delete('/:userName', validateToken, validateRolToken(['Administrador']), userController.remove)
